...
public class GerenciaFaculdade {
    ...
    //constantes para nomes de arquivos e separador
    ...
    //scanner para entrada do usuário (usado nos menus interativos)
    ...
    /**
     * Método para estabelecer as conexões entre os objetos após o carregamento
     * dos arquivos CSV. Por exemplo, associar o objeto Curso correto ao Aluno.
     */
    private static void ligarReferencias() {
        ...
        //Ligar Professores às Matérias (e vice-versa, se necessário)
            ...
            if (professor.getCodigosMaterias() != null) {
                for (String codMateria : professor.getCodigosMaterias()) {
                    ...
                    if (materiaEncontrada != null) {
                        ...
                        //Opcional: Adicionar professor à matéria (se a classe Materia tiver essa referência)
        ...
        //Ligar Notas aos Alunos e Matérias (e vice-versa)
        for (Nota nota : notas) {
            boolean notaOk = true;
            if (nota.getCodigoAluno() != null) {
                ...
                if (alunoEncontrado != null) {
                 ...
                 logger.logErro("Nota (Tipo: " + nota.getTipoAvaliacao() + ") sem código de aluno.");
                 notaOk = false;
            }
            ...
            if (nota.getCodigoMateria() != null) {
                ...
                if (materiaEncontrada != null) {
                    ...
                    //Adiciona a nota à lista da matéria (se ainda não existir)
                    ...
                    logger.logErro("Nota (Tipo: " + nota.getTipoAvaliacao() + ", Aluno: "+nota.getCodigoAluno()+") referencia matéria inexistente: " + nota.getCodigoMateria());
                }
            } else {
                 logger.logErro("Nota (Tipo: " + nota.getTipoAvaliacao() + ", Aluno: "+nota.getCodigoAluno()+") sem código de matéria.");
            }
        }
