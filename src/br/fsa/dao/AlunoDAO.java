...
/**
 * dao pra alunos, responsavel por ler e escrever dados de alunos em arquivo csv.
 * versao simplificada: nao tenta resolver referencias a cursos durante a leitura.
 */
public class AlunoDAO implements LeitorArquivo<Aluno> {

    private String arquivoCsvAlunos;
    private static final String SEPARADOR = ";";
    private Log logger; //instancia do log

    //construtor simplificado, recebe so o logger
    public AlunoDAO(Log logger) {
        this.logger = logger;
        //define um nome padrao ou exige via setarquivo
